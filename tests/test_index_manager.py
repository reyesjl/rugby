...
def make_indexing_config(ai_provider="openai", model="gpt-3.5-turbo", instructions="Summarize the transcript.", system="You are a helpful assistant."):
...
def test_summarize_srt_file_unsupported_provider():
	...
	with pytest.raises(ValueError, match="Unsupported AI provider: otherai. Only 'openai' is supported."):
		index_manager.summarize_srt_file(config, "dummy.srt")
