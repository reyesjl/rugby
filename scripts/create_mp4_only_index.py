...
def create_mp4_only_index(
    index_path: str = os.path.join("animus", "data", "master_video_index.json"),
):
    ...
    backup_path = os.path.join(
        os.path.dirname(index_path), "master_video_index_full_backup.json"
    )
    ...
    print("🎬 Master video index updated:")
    print(f"   - Removed {mpg_count} MPG entries")
    print(f"   - Kept {mp4_count} MP4 entries")
    print("   - Your application now only sees MP4 files!")
